  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      <UnreadMessagesProvider>
        ...
        <footer className="bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-blue-900 dark:to-indigo-950 text-white py-8 mt-auto">
          <div className="border-blue-400/20 dark:border-blue-800/20 text-center text-sm text-blue-100">
              ...
              <nav className="hidden sm:ml-6 sm:flex sm:space-x-1">
                {[
                  ...
                  <Link
                    key={link.href}
                    href={link.href}
                    className="text-blue-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-blue-800/50"
                  >
                    {link.label}
                  </Link>
                ))}
          ...
          <div className="flex items-center space-x-4">
            ...
            {session && (
              <button
                ...
                className="sm:hidden inline-flex items-center justify-center p-2 rounded-md text-blue-100 hover:text-white hover:bg-blue-800/50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white transition-colors"
              >
