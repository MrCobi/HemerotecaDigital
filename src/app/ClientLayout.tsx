        ...
        <div className="flex justify-between items-center h-14 sm:h-16 md:h-20">
          ...
          <div className="flex items-center">
            ...
            <div className="flex-shrink-0 flex items-center">
              ...
              >
                <div className="relative w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 overflow-hidden rounded-lg transform transition-transform group-hover:scale-105">
                  <Image
                ...
                <span className="ml-2 md:ml-3 text-white font-semibold text-base sm:text-lg hidden xs:block transform transition-all group-hover:scale-105">
                  Hemeroteca Digital
                </span>
              </Link>
            </div>
            ...
            {session && (
              <nav className="hidden sm:ml-4 md:ml-6 sm:flex sm:space-x-1 md:space-x-2">
                {[
                  ...
                  <Link
                    key={link.href}
                    href={link.href}
                    className="text-blue-100 hover:text-white px-2 md:px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-blue-800/50"
                  >
                    {link.label}
                  </Link>
                ))}
      ...
      {session && (
        <div
          className={`sm:hidden transition-all duration-300 ease-in-out ${isMenuOpen
              ? "max-h-80 opacity-100 shadow-lg"
